...
# Create the DAG
dag = DAG(
    'velib_refresh_and_retrain',
    default_args=default_args,
    description='Refresh data and retrain model in sequence',
    schedule_interval='0 1 * * 0',  # Every Sunday at 1 AM
    catchup=False,
    tags=['velib', 'data', 'ml', 'combined'],
)
...
# Set task dependencies: health check -> refresh -> retrain
health_check >> refresh_data >> retrain_model
