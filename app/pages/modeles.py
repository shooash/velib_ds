...
- Oversampling, multiplication artificielle de class "rush" dans le dataset d'entrainement.
- Undersampling: resampling de la classe majoritaire pour qu'elle soit seulement 3 fois plus grande que le class "rush".
...
# Top-3
## XGB Performant
Les modèles MLP et CNN présentés ont été les plus performants au cours de testes. Pour bien finaliser le top-3 il vaut noter le **XGBRegressor** qui, avec un lissage de données sur une fenêtre de **4** et weighting égale à **5**, est capable pour des meilleures prédictions:
